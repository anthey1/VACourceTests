...
* Контроль соответствия Количества, цены, суммы, согласно эталонным значениями
	// ВАЖНО для проверки разделитель разрядов " " указывать иначе будет ошибка
	// Проверяем корректность данных в ТЧ при "неправильном" значении реквизита "Количество" = 2...
	Тогда таблица "Товары" содержит строки:
		| 'Номенклатура'                                       | 'Количество' | 'Цена'    | 'Сумма'    |
